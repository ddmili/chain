...
func (m *VersionRequest) GetAge() int32 {
	if m != nil {
		return m.Age
	}
	return 0
...
var fileDescriptor_9621718efbbc1f14 = []byte{
	...
	,
}
...
func (c *chainClient) Version(ctx context.Context, in *VersionRequest, opts ...grpc.CallOption) (*VersionResponse, error) {
	out := new(VersionResponse)
	err := c.cc.Invoke(ctx, "/Chain/Version", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Chain_Version_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/Chain/Version",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ChainServer).Version(ctx, req.(*VersionRequest))
	}
